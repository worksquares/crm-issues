...
**Live app:** https://crm.worksquares.ai · **API:** https://crm-api.worksquares.ai · **Docs:** https://docs.worksquares.ai
...
- **Feature request** — something you'd like the product to do.
...
**Do not report security vulnerabilities as public issues.** Use [private vulnerability reporting](https://github.com/worksquares/crm-issues/security/advisories/new) instead — see [SECURITY.md](SECURITY.md).

## What happens after you file

New issues are triaged and labeled by the team. When a fix ships, the issue is closed with a comment noting the release it landed in.
